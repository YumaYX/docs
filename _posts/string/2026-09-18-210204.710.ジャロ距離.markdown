...
- [ジャロ・ウィンクラー類似度]({% post_url string/2026-09-18-210205.710.ジャロ・ウィンクラー類似度 %}) の土台になる
...
前: [ハミング距離]({% post_url string/2026-09-18-210203.710.ハミング距離 %})

次: [ジャロ・ウィンクラー類似度]({% post_url string/2026-09-18-210205.710.ジャロ・ウィンクラー類似度 %})
