...
[ジャロ距離]({% post_url text/2026-09-18-210204.710.ジャロ距離 %}) に **「先頭が何文字一致しているか」のボーナス** を加えた 0〜1 の類似度。
...
前: [ジャロ距離]({% post_url text/2026-09-18-210204.710.ジャロ距離 %})

次: [正規化編集距離]({% post_url text/2026-09-18-210206.710.正規化編集距離 %})
