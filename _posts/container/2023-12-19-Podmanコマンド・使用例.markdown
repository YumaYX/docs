...
※ `docker ps` が動くのは、podman-docker により `docker` が podman のエイリアスとして提供されているため
...
[Podmanで独自コンテナイメージとボリュームを使うpodの作成 - 作業ログ源泉垂れ流し](https://non-filtered-worklog.hateblo.jp/entry/2021/06/15/230119)
