...
- 挿入・削除がある可能性があるなら、[レーベンシュタイン距離]({% post_url string/2026-09-18-210201.710.レーベンシュタイン距離 %}) を使う。
...
前: [ダメラウ・レーベンシュタイン距離]({% post_url string/2026-09-18-210202.710.ダメラウ・レーベンシュタイン距離 %})

次: [ジャロ距離]({% post_url string/2026-09-18-210204.710.ジャロ距離 %})
